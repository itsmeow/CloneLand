...
import its_meow.cloneland.common.dimension.CloneTeleporter;
		...
		if(!worldIn.isRemote){
			if (playerIn instanceof EntityPlayerMP){
				...
				if(playerIn.getRidingEntity() == null | false && playerIn.isBeingRidden() == false && playerIn instanceof EntityPlayer) {
					...
					playerMP.server.getPlayerList().transferPlayerToDimension(playerMP, matching, new CloneTeleporter(playerIn.getServer().getWorld(matching)));
